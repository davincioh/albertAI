...
목적
---
우리는 지금 사람과 로봇이 함께 공존하는 시대에 살고 있습니다. 컴퓨터와 소통하는 방법을 터득해 유용하게 사용했듯, 앞으로는 로봇과의 소통방법이 중요해 질 것 입니다. 이 프로젝트는 사람과 로봇간의 Interaction을 연구함에 있어 도움이 되기위해 작성 되었습니다. albert AI는 첨단기술이 집약된 하드웨어와 AI기술을 바탕으로 개발되었으며 사용자는 별도의 개발 혹은 코딩 없이 손쉽게 사용가능합니다. HRI 연구에 유용하게 활용되길 희망합니다. 
