...
목적
---
우리는 지금 로봇과 함께 공존하는 시대에 살고 있습니다. 지금까지 컴퓨터와 소통하는 방법을 학습하여 우리의 삶에 유용하게 사용했듯 앞으로는 로봇과의 소통방법이 중요 해 질 것 입니다. 이 프로젝트는 사람과 로봇간의 상호작용에 관해 일반인부터 연구원까지 함께 고민하고 이에 필요한 도구와 환경을 제공하기 위해 작성되었습니다.
- albert AI는 완성형 하드웨어(로봇)와 비개발자도 사용 가능한 저작도구를 제공함으로써 대화시스템 연구에 보다 몰두 할 수 있습니다.
- 우리의 삶에 대화가 가능한 로봇이 필요한 곳에 albert AI를 활용해 보세요. 이 로봇은 사람의 말을 듣고 이해하며 남자어린아이 목소리로 대답하고 공감합니다. 
